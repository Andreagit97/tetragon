...
func (s *disabled) AddForEachCgroupPolicy(polID PolicyID, refPolID PolicyID, namespace string, podLabelSelector *slimv1.LabelSelector,
...
func (s *disabled) DeleteForEachCgroupPolicy(polID PolicyID) error {
	return disabledError()
}

func (s *disabled) AddForEachCgroupTracker(polID PolicyID, workloadMap *ebpf.Map) error {
	return disabledError()
}

func (s *disabled) DeleteForEachCgroupTracker(polID PolicyID) error {
	return disabledError()
}
